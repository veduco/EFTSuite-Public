...
2. Type 4 records are now createable to appease SilencerShop (which requires Type 4 records for some reason). I recommend using Type 14 records (ATF-compliant) unless you explicitly need Type 4 records.
